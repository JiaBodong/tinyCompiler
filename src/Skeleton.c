...
const char* TypeTransferExpr(enum  Expr_ { is_EVar, is_ELitInt, is_ELitDoub, is_ELitTrue, is_ELitFalse, is_EApp, is_EString, is_Neg, is_Not, is_EMul, is_EAdd, is_ERel, is_EAnd, is_EOr } kind){
  switch(kind)
  {
  case is_ELitInt:
    return "Int";
...
const char* TypeTransferType(enum  Type_ { is_Int, is_Doub, is_Bool, is_Void, is_Fun } kind){
  switch(kind)
  {
  case is_Int:
    return "Int";
